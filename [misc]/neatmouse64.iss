...
MinVersion=6.0
OutputBaseFilename={#ApplicationFileNameWithoutExtension}-{#ApplicationVersion}-setup-x64
PrivilegesRequired=lowest
AppPublisher=Neat Decisions
AppPublisherURL=https://www.neatdecisions.com/
Uninstallable=not WizardIsComponentSelected('portable')
...
begin
  ...
  begin
    ...
    begin
      Result := (PageID = wpSelectProgramGroup) and WizardIsComponentSelected('portable');
    end;
  end;
end;
